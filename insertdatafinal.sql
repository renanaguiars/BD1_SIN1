...
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/02/27 07:25:32', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/03/01 19:15:29', 'yyyy/mm/dd hh24:mi:ss'), 105, 200);
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/03/01 10:39:11', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/03/04 12:24:10', 'yyyy/mm/dd hh24:mi:ss'), 106, 201);
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/03/02 16:54:56', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/03/05 18:49:37', 'yyyy/mm/dd hh24:mi:ss'), 107, 202);
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/03/04 18:12:37', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/03/08 16:20:11', 'yyyy/mm/dd hh24:mi:ss'), 108, 203);
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/04/22 10:10:57', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/04/25 11:02:00', 'yyyy/mm/dd hh24:mi:ss'), 109, 204);
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/05/08 09:38:31', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/05/12 07:35:12', 'yyyy/mm/dd hh24:mi:ss'), 110, 200);
insert into OCUPACAO (idocupacao, dataEntrada, dataSaida, id_carro, id_vaga) values(1005, TO_DATE('2020/06/12 07:32:47', 'yyyy/mm/dd hh24:mi:ss'), TO_DATE('2020/06/15 10:45:25', 'yyyy/mm/dd hh24:mi:ss'), 111, 201);